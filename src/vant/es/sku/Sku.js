...
export default createComponent({
  props: {
    ...
    inventory: String,
    selectText: String,
    selectededText: String,
    atLeastOne: String,
    selectGoodsFirst: String,
    quota: {
      type: Number,
      default: 0
    },
  ...
  computed: {
    ...
    stockText: function stockText() {
      ...
      return this.inventory + ' ' + this.stock //+ "\u4EF6"; 库存
    },
    ...
    selectedText: function selectedText() {
      ...
      if (this.selectedSkuComb) {
        return this.selectededText + ' ' + this.selectedSkuValues.map(function (item) {
          return item.name;
        }).join('；'); // 已选
      }
      ...
      return this.selectText + ' '+ unselected;//选择
    }
  },
  ...
  methods: {
    ...
    validateSku: function validateSku() {
      ...
      return this.selectGoodsFirst;//请先选择商品规格
    },
